...
public class ProductResourceIT {
    ...
    private static final Integer DEFAULT_COUNT_IN_STOCK = 1;
    private static final Integer UPDATED_COUNT_IN_STOCK = 2;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .type(DEFAULT_TYPE)
            .price(DEFAULT_PRICE)
            .countInStock(DEFAULT_COUNT_IN_STOCK)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .type(UPDATED_TYPE)
            .price(UPDATED_PRICE)
            .countInStock(UPDATED_COUNT_IN_STOCK)
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getCountInStock()).isEqualTo(DEFAULT_COUNT_IN_STOCK);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].countInStock").value(hasItem(DEFAULT_COUNT_IN_STOCK)))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.countInStock").value(DEFAULT_COUNT_IN_STOCK))
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getCountInStock()).isEqualTo(UPDATED_COUNT_IN_STOCK);
